...
resource "aws_lb_listener" "https_saopaulo" {
  ...
  certificate_arn = data.aws_acm_certificate.cert_saopaulo.arn
...
resource "aws_lb_listener" "https_tokyo" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_tokyo.arn
...
resource "aws_lb_listener" "https_london" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_london.arn
...
resource "aws_lb_listener" "https_newyork" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_newyork.arn
...
resource "aws_lb_listener" "https_sydney" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_sydney.arn
...
resource "aws_lb_listener" "https_Ncalifornia" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_Ncalifornia.arn
...
resource "aws_lb_listener" "https_hongkong" {
  ...
  protocol = "HTTPS"
  ssl_policy = "ELBSecurityPolicy-2016-08"
  certificate_arn = data.aws_acm_certificate.cert_Hongkong.arn
